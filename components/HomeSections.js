...
const WaitResult=()=> <img className="pending-result-gif" src="/assets/img/wait.gif" alt="Result awaiting update" width="40" height="40"/>;
const todayResultDisplay=(results,game)=>hasResult(results,game,today())?resultFor(results,game,today()):<WaitResult/>;
