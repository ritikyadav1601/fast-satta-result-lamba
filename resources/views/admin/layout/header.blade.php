    ...
    <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        ...
        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
          ...
          <ul class="py-2" aria-labelledby="user-menu-button">
            ...
            <li>
              <a href="{{ route('admin.setting') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Settings</a>
            </li>
            <li>
...
<div id="mobile-sidebar" class="fixed top-0 left-0 z-40 w-64 h-full bg-white dark:bg-gray-900 transform -translate-x-full transition-transform">
  <div class="p-4">
      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
            <a href="{{ route('admin.home') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                <span class="ms-3">Games</span>
            </a>
        </li>
        <li>
            <a href="{{ route('admin.game.result') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                <span class="ms-3">Game Result</span>
            </a>
        </li>
        <li>
            <a href="{{ route('admin.bulk.result') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                <span class="ms-3">Old Result</span>
            </a>
        </li>
          <li>
              <a href="{{ route('admin.other.chart') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  <span class="ms-3">Other Chart</span>
              </a>
          </li>
        <li>
            <a href="{{ route('admin.question') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                <span class="ms-3">Question Answer</span>
            </a>
        </li>
        <li>
            <a href="{{ route('admin.faq') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
